    ...
    return (
        <div className="Footer__Footer__2T3w3">
            <div className="Footer__Row__2Koch">
                ...
                </div><div className="Footer__Column__1mRXM">
                ...
                <div className="Footer__Column__1mRXM Footer__SocialLinksContainer__2kpSA">
                    ...
                    <div className="Footer__Column__1mRXM">
                        ...
                        <a href="mailto:hello@edyoda.com" target="_blank" rel="noopener noreferrer">
                            <img src="https://www.edyoda.com/static/media/email-white.e7d51381.svg" alt="EdYoda Email Icon" className="Footer__ContactIcon__2TTbB" />hello@edyoda.com
                            </a>
                        <div className="Footer__SocialLinks__174hs">
                            ...
                            <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/EdYodaHQ">
                                <img src="https://www.edyoda.com/static/media/twitter-white-icon.ea27ab22.svg" alt="EdYoda Twitter Icon" className="Footer__SocialIcon__2m5Mx" />
                            </a>
